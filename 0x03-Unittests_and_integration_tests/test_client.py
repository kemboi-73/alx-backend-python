#!/usr/bin/env python3
"""Implements a parametized unit test"""
import unittest
...
class TestGithubOrgClient(unittest.TestCase):
    """Contains test suites for tasks 5-8"""
    ...
    def test_org(self, org, get_json):
        """This function tests that GithubOrgClient.org
    ...
    def test_public_repos_url(self):
        """This method implements the test_public_repos_url method to unit-test
    ...
    def test_public_repos(self, smada):
        """This method implements TestGithubOrgClient.test_public_repos to
    ...
    def test_has_license(self, license, license_key, expected):
        """This method implements TestGithubOrgClient.test_has_license
...
def requests_get(*args, **kwargs):
    """
    This function mocks requests.get function and
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """
   Contains Integration test for the GithubOrgClient.public_repos method
    """
    @classmethod
    def setUpClass(cls):
        """
        Sets up function for TestIntegrationGithubOrgClient class
    ...
    def tearDownClass(cls):
        """
        Tears down resources set up for class tests.
    ...
    def test_public_repos(self):
        """
        Tests public_repos method without license
        """
